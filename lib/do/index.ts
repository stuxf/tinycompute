...
export { DOApiError, assertDOId, doRequest } from "./base";
export { DODropletsClient } from "./droplets";
export type {
  Droplet,
  DropletSize,
  DropletImage,
...
export { DOProjectsClient } from "./projects";
export type { Project, ProjectResource } from "./projects";

import { DODropletsClient } from "./droplets";
import { DOProjectsClient } from "./projects";
